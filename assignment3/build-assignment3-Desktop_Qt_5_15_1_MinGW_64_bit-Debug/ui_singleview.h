...
public:
    ...
    void setupUi(QDialog *singleView)
    {
        ...
        wob->setGeometry(QRect(450, 470, 55, 16));
        ...
        distance->setGeometry(QRect(450, 410, 291, 41));
