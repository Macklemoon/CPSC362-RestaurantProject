...
public:
    ...
    void setupUi(QDialog *addAccount)
    {
        ...
        addAccount->setSizeGripEnabled(false);
        addAccount->setModal(false);
        ...
        label_2->setGeometry(QRect(20, 10, 331, 31));
        QFont font1;
    ...
    {
        addAccount->setWindowTitle(QCoreApplication::translate("addAccount", "Create Account", nullptr));
        label->setText(QCoreApplication::translate("addAccount", "Create your Account", nullptr));
        label_2->setText(QCoreApplication::translate("addAccount", "Restaurant Metrics", nullptr));
